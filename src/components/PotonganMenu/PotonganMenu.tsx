...
import { IonButton, IonLabel, IonMenu, IonSegment, IonSegmentButton } from "@ionic/react";
...
export const PotonganMenu = (props: Props) => {
  return (
      ...
      <div className="pilih ripple-effect">
        <IonSegment value={"facade"} mode={"ios"} color="primary" className="potongan">
          <IonSegmentButton value="facade" id="facade">
            <IonLabel>Facade</IonLabel>
          </IonSegmentButton>
          <IonSegmentButton value="skydeck" id="skydeck">
            <IonLabel>Skydeck</IonLabel>
          </IonSegmentButton>
